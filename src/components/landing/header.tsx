                  ...
                  <div key={link.label} className="w-full">
                    {link.subItems ? (
                      <MobileAccordion title={link.label} icon={LinkIcon}>
                        {link.subItems.map((subItem) => (
                          <Link
                            ...
                            href={subItem.href}
                            onClick={() => setOpen(false)}
                            className="block py-2 pl-6 text-[15px] font-medium rounded-xl text-white border-l-2 border-l-transparent transition-all duration-200 hover:bg-white hover:text-purple-900 hover:pl-8"
                          >
                            {subItem.label}
                          </Link>
                        ))}
                      ...
                      <button
                        ...
                        className="group w-full flex items-center gap-3 px-5 py-3 text-left text-[16px] rounded-xl mt-3 shadow-xl border border-white/20 font-semibold text-white bg-transparent outline-none transition-all duration-200 hover:bg-white hover:text-purple-900"
                      >
                        <div className="bg-white/10 group-hover:bg-purple-100 rounded-full p-[6px] border border-white/20 group-hover:border-purple-200 shrink-0 flex items-center justify-center transition-colors duration-200">
